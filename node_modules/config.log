# /Users/spencerharwood/Documents/GitProjects/discord_bot/node_modules/ffmpeg-3.3.2/configure 
ALL_COMPONENTS='
    aac_adtstoasc_bsf
chomp_bsf
dump_extradata_bsf
...
BASH_ARGV=()
BASH_LINENO=([0]="0")
BASH_SOURCE=([0]="/Users/spencerharwood/Documents/GitProjects/discord_bot/node_modules/ffmpeg-3.3.2/configure")
...
SUBSYSTEM_LIST='
    ...
    rdft
'
SUDO_COMMAND=/Users/spencerharwood/Documents/GitProjects/discord_bot/node_modules/ffmpeg-3.3.2/configure
SUDO_GID=20
SUDO_UID=503
...
_='# /Users/spencerharwood/Documents/GitProjects/discord_bot/node_modules/ffmpeg-3.3.2/configure '
...
source_path=/Users/spencerharwood/Documents/GitProjects/discord_bot/node_modules/ffmpeg-3.3.2
sox_demuxer=yes
sox_muxer=yes
sp5x_decoder=yes
...
check_ld cc
check_cc
BEGIN /tmp/ffconf.cr0se8IM.c
    1	int main(void){ return 0; }
END /tmp/ffconf.cr0se8IM.c
gcc -c -o /tmp/ffconf.N04eBsST.o /tmp/ffconf.cr0se8IM.c
gcc -o /tmp/ffconf.XCkOHbOI /tmp/ffconf.N04eBsST.o
check_cxxflags -std=c++11
check_cxx -std=c++11
BEGIN /tmp/ffconf.2Qnt1cgr.cpp
    1	int x;
END /tmp/ffconf.2Qnt1cgr.cpp
g++ -D_ISOC99_SOURCE -D__STDC_CONSTANT_MACROS -std=c++11 -c -o /tmp/ffconf.N04eBsST.o /tmp/ffconf.2Qnt1cgr.cpp
...
BEGIN /tmp/ffconf.cr0se8IM.c
    ...
    4	#endif
END /tmp/ffconf.cr0se8IM.c
gcc -D_ISOC99_SOURCE -std=c11 -c -o /tmp/ffconf.N04eBsST.o /tmp/ffconf.cr0se8IM.c
check_cc -D_FILE_OFFSET_BITS=64
BEGIN /tmp/ffconf.cr0se8IM.c
    1	#include <stdlib.h>
END /tmp/ffconf.cr0se8IM.c
gcc -D_ISOC99_SOURCE -std=c11 -D_FILE_OFFSET_BITS=64 -c -o /tmp/ffconf.N04eBsST.o /tmp/ffconf.cr0se8IM.c
check_cc -D_LARGEFILE_SOURCE
BEGIN /tmp/ffconf.cr0se8IM.c
    1	#include <stdlib.h>
END /tmp/ffconf.cr0se8IM.c
gcc -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -std=c11 -D_LARGEFILE_SOURCE -c -o /tmp/ffconf.N04eBsST.o /tmp/ffconf.cr0se8IM.c
check_host_cflags -std=c99
check_host_cc -std=c99
BEGIN /tmp/ffconf.cr0se8IM.c
    1	int x;
END /tmp/ffconf.cr0se8IM.c
gcc -std=c99 -c -o /tmp/ffconf.N04eBsST.o /tmp/ffconf.cr0se8IM.c
check_host_cflags -Wall
check_host_cc -Wall
BEGIN /tmp/ffconf.cr0se8IM.c
    1	int x;
END /tmp/ffconf.cr0se8IM.c
gcc -std=c99 -Wall -c -o /tmp/ffconf.N04eBsST.o /tmp/ffconf.cr0se8IM.c
check_host_cflags -O3
check_host_cc -O3
BEGIN /tmp/ffconf.cr0se8IM.c
    1	int x;
END /tmp/ffconf.cr0se8IM.c
gcc -std=c99 -Wall -O3 -c -o /tmp/ffconf.N04eBsST.o /tmp/ffconf.cr0se8IM.c
check_code cc  int test[2*(sizeof(void *) > 4) - 1]
check_cc
BEGIN /tmp/ffconf.cr0se8IM.c
    1	int main(void) { int test[2*(sizeof(void *) > 4) - 1]; return 0; }
END /tmp/ffconf.cr0se8IM.c
gcc -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -std=c11 -c -o /tmp/ffconf.N04eBsST.o /tmp/ffconf.cr0se8IM.c
...
BEGIN /tmp/ffconf.cr0se8IM.c
    ...
    2	int x;
END /tmp/ffconf.cr0se8IM.c
gcc -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -std=c11 -E -o /tmp/ffconf.N04eBsST.o /tmp/ffconf.cr0se8IM.c
...
BEGIN /tmp/ffconf.cr0se8IM.c
    ...
    4	#endif
END /tmp/ffconf.cr0se8IM.c
gcc -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -I$(SRC_PATH)/compat/dispatch_semaphore -std=c11 -E -o /tmp/ffconf.N04eBsST.o /tmp/ffconf.cr0se8IM.c
/tmp/ffconf.cr0se8IM.c:1:10: fatal error: 'features.h' file not found
#include <features.h>
         ^
1 error generated.
...
END /tmp/ffconf.cr0se8IM.c
gcc -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -I$(SRC_PATH)/compat/dispatch_semaphore -std=c11 -E -o /tmp/ffconf.N04eBsST.o /tmp/ffconf.cr0se8IM.c
/tmp/ffconf.cr0se8IM.c:1:10: fatal error: 'newlib.h' file not found
#include <newlib.h>
         ^
1 error generated.
...
END /tmp/ffconf.cr0se8IM.c
gcc -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -I$(SRC_PATH)/compat/dispatch_semaphore -std=c11 -E -o /tmp/ffconf.N04eBsST.o /tmp/ffconf.cr0se8IM.c
/tmp/ffconf.cr0se8IM.c:1:10: fatal error: '_mingw.h' file not found
#include <_mingw.h>
         ^
1 error generated.
...
END /tmp/ffconf.cr0se8IM.c
gcc -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -I$(SRC_PATH)/compat/dispatch_semaphore -std=c11 -E -o /tmp/ffconf.N04eBsST.o /tmp/ffconf.cr0se8IM.c
/tmp/ffconf.cr0se8IM.c:1:10: fatal error: 'crtversion.h' file not found
...
END /tmp/ffconf.cr0se8IM.c
gcc -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -I$(SRC_PATH)/compat/dispatch_semaphore -std=c11 -E -o /tmp/ffconf.N04eBsST.o /tmp/ffconf.cr0se8IM.c
/tmp/ffconf.cr0se8IM.c:3:2: error: "unsatisfied condition: defined __KLIBC__"
...
END /tmp/ffconf.cr0se8IM.c
gcc -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -I$(SRC_PATH)/compat/dispatch_semaphore -std=c11 -E -o /tmp/ffconf.N04eBsST.o /tmp/ffconf.cr0se8IM.c
/tmp/ffconf.cr0se8IM.c:3:2: error: "unsatisfied condition: defined __BIONIC__"
...
END /tmp/ffconf.cr0se8IM.c
gcc -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -I$(SRC_PATH)/compat/dispatch_semaphore -std=c11 -E -o /tmp/ffconf.N04eBsST.o /tmp/ffconf.cr0se8IM.c
/tmp/ffconf.cr0se8IM.c:1:10: fatal error: 'sys/brand.h' file not found
#include <sys/brand.h>
         ^
1 error generated.
check_cc
...
END /tmp/ffconf.cr0se8IM.c
gcc -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -I$(SRC_PATH)/compat/dispatch_semaphore -std=c11 -c -o /tmp/ffconf.N04eBsST.o /tmp/ffconf.cr0se8IM.c
...
BEGIN /tmp/ffconf.cr0se8IM.c
    ...
    4	#endif
END /tmp/ffconf.cr0se8IM.c
gcc -D_ISOC99_SOURCE -std=c99 -Wall -O3 -E -o /tmp/ffconf.N04eBsST.o /tmp/ffconf.cr0se8IM.c
/tmp/ffconf.cr0se8IM.c:1:10: fatal error: 'features.h' file not found
#include <features.h>
         ^
1 error generated.
...
BEGIN /tmp/ffconf.cr0se8IM.c
    1	int x;
END /tmp/ffconf.cr0se8IM.c
gcc -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -I$(SRC_PATH)/compat/dispatch_semaphore -std=c11 -fomit-frame-pointer -c -o /tmp/ffconf.N04eBsST.o /tmp/ffconf.cr0se8IM.c
check_cc
BEGIN /tmp/ffconf.cr0se8IM.c
    1	int ff_extern;
END /tmp/ffconf.cr0se8IM.c
gcc -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -I$(SRC_PATH)/compat/dispatch_semaphore -DPIC -std=c11 -fomit-frame-pointer -fPIC -c -o /tmp/ffconf.N04eBsST.o /tmp/ffconf.cr0se8IM.c
check_cc
BEGIN /tmp/ffconf.cr0se8IM.c
...
END /tmp/ffconf.cr0se8IM.c
gcc -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -I$(SRC_PATH)/compat/dispatch_semaphore -DPIC -std=c11 -fomit-frame-pointer -fPIC -c -o /tmp/ffconf.N04eBsST.o /tmp/ffconf.cr0se8IM.c
In file included from /tmp/ffconf.cr0se8IM.c:1:
...
END /tmp/ffconf.cr0se8IM.c
gcc -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -I$(SRC_PATH)/compat/dispatch_semaphore -DPIC -std=c11 -fomit-frame-pointer -fPIC -c -o /tmp/ffconf.N04eBsST.o /tmp/ffconf.cr0se8IM.c
gcc -Wl,-dynamic,-search_paths_first -o /tmp/ffconf.XCkOHbOI /tmp/ffconf.N04eBsST.o
check_exec_crash
check_ld cc
check_cc
BEGIN /tmp/ffconf.cr0se8IM.c
...
gcc -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -I$(SRC_PATH)/compat/dispatch_semaphore -DPIC -std=c11 -fomit-frame-pointer -fPIC -c -o /tmp/ffconf.N04eBsST.o /tmp/ffconf.cr0se8IM.c
yasm --version
/Users/spencerharwood/Documents/GitProjects/discord_bot/node_modules/ffmpeg-3.3.2/configure: line 883: yasm: command not found
nasm -v
NASM version 0.98.40 (Apple Computer, Inc. build 11) compiled on Nov 15 2016
check_yasm movbe ecx, [5]
BEGIN /tmp/ffconf.tlg1YXMD.S
    1	movbe ecx, [5]
END /tmp/ffconf.tlg1YXMD.S
nasm -f macho64 -DPIC -DPREFIX -Werror -o /tmp/ffconf.N04eBsST.o /tmp/ffconf.tlg1YXMD.S
